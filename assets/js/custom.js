...
$(document).ready(function() {
  ...
  var csvfile_import_122860 = "https://drive.google.com/uc?export=download&id=0BzJvrqgRIJDIUkFzbzNoa1lwOG8".replace(/\&amp\;/g, '&');
  
  $('.122860 .databaseTable_import_wrap').CSVToTable( csvfile_import_122860 , { loadingText: 'Generating Table', loadingImage: 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/301208/loading.gif', startLine: 0, tableClass: "databaseTable_import", theadClass: "heading" }).bind("loadComplete",function() { 
...
$( "th:nth-child(1)").css("position", "fixed", "left", "0");